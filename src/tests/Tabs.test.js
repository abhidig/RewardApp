...
describe('Tabs Component', () => {
  ...
  // test('renders correct reward points in Transactions tab', () => {
  //   render(<Tabs transactions={mockData} />);
  //   fireEvent.click(screen.getByLabelText('Transactions'));
  ...
  // test('renders correct monthly rewards', () => {
  //   render(<Tabs transactions={mockData} />);
  //   expect(screen.getByText('January')).toBeInTheDocument();
  //   expect(screen.getByText('February')).toBeInTheDocument();
  // });

  // test('renders correct total rewards', () => {
  //   render(<Tabs transactions={mockData} />);
  //   fireEvent.click(screen.getByLabelText('Total Rewards'));
  ...
  // test('renders correct last three months rewards', () => {
  //   render(<Tabs transactions={mockData} />);
  //   fireEvent.click(screen.getByLabelText('Total Rewards'));
  //   expect(screen.getByText('90')).toBeInTheDocument();
  //   expect(screen.getByText('30')).toBeInTheDocument();
  ...
  // test('renders correct yearly rewards', () => {
  //   render(<Tabs transactions={mockData} />);
  //   fireEvent.click(screen.getByLabelText('Yearly Rewards'));
